...
<li>An "Open work tab" option that opens the work tab and highlights the work type pawn so it's super easy to assign priority for that work type.
  ...
  <sub>These features are borrowed from Better Work Tab. I thought it would make a quite fine QOL mod on its own for people who don't want to commit to the full BWT transformation. 
  <i>While this mod is fully compatible with Better Work Tab, doing so is redundant since this mod is borrowing BWT's functionality.</i></sub>
